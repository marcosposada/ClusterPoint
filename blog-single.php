		<?php
			...
			$query = "SELECT * FROM {$wpdb->posts} WHERE post_type = 'post' AND post_name = '{$single_slug}' AND post_status = 'publish' LIMIT 1";
			# blog item
			...
			endforeach;
			# prepare content 
			$body_text = nl2br($blog_item[0]->post_content);
		...
		<div id="page-blog-single" class="page-wrap single-wrap">	
			...
			<section id="single-content" class="content white-before" data-ch="true">
				<div class="container">
					<div class="row">
						<div class="col-md-10 col-xs-12 center-block el-animation-2">
							<?php echo $content; ?>	
