...
class Highlighter {
  ...
  */
  protected $colors = Array('chars' => 'grey', 'keywords' => 'purple', 'joins' => 'gray', 'functions' => 'purple', 'constants' => 'red');
  /*
  ...
  */
  ...
  'keywords' =>
    ...
    'PRIMARY', 'AUTO_INCREMENT', 'DEFAULT', 'IDENTITY', 'VALUES', 'VALUE', 'PROCEDURE', 'FUNCTION', 
  ...
  */
  ...
  public function highlight($sql)
  {
    ...
    foreach($this->colors as $key=>$color)
    {
      ...
      $sql = preg_replace($regexp, '<span class="'.$color."\">$1</span>", $sql);
    }
    return $sql;
  }
}
